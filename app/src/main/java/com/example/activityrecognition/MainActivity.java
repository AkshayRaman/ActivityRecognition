...
public class MainActivity extends AppCompatActivity
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mHeader = findViewById(
                R.id.detected_activities_title);
    ...
    private void setButtonsEnabledState() {
        if (getUpdatesRequestedState()) {
            mRequestActivityUpdatesButton.setVisibility(View.GONE);
            mQuitButton.setVisibility(View.GONE);
            mRemoveActivityUpdatesButton.setVisibility(View.VISIBLE);
            mHeader.setVisibility(View.VISIBLE);
            detectedActivitiesListView.setVisibility(View.VISIBLE);
        } else {
            mRequestActivityUpdatesButton.setVisibility(View.VISIBLE);
            mQuitButton.setVisibility(View.VISIBLE);
            mRemoveActivityUpdatesButton.setVisibility(View.GONE);
            mHeader.setVisibility(View.GONE);
            detectedActivitiesListView.setVisibility(View.GONE);
        }
    }
